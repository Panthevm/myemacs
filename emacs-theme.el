...
(setq emacs-theme.color-1 "#bf4040")
(setq emacs-theme.color-2 "#aebbc8")
(setq emacs-theme.color-3 "#2c2a29")
...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   'emacs
   `(default
      ((,class (:background ,emacs-theme.color-3 :foreground ,emacs-theme.color-2))))
   ...
   `(cursor
     ((,class (:background ,emacs-theme.color-1))))
